...
import com.miles.PageLibRepo.ATSCounselingLib;
...
public class Miles_ATS_FlowAsCounselingTeam extends MilesSettings
{	
...
//	 String ExpectedEligibilityType = "Eligibility not done";
	...
	//	System.out.println();
		 ...
		 {
			homeObj = loginObj.login("manojexpert",MilesUtilities.DecryptPass("MTIzNDEyMzQ="));
			 //MTIzNDEyMzQ=
...
{
	ATSCounselingLib ATSC = new ATSCounselingLib(driver);
	CandidateData();
}
