...
public class FxShareActivity_AsUser extends MilesSettings
{
	 ...
	 private void Initialize(String env)
    {
		 ...
		 try
		 {
			 ...
			 {									//PROD//
				 homeObj = login.login("quality+automationProd@fourthfrontier.com",MilesUtilities.DecryptPass("MTIzNDEyMzQ="));
				 System.out.println("Logging in as Quality : Serverless Production user");
			 }
			 
			 else
			 {   // Regular Prod User			//STAGE//
				 homeObj = login.login("quality+automation@fourthfrontier.com",MilesUtilities.DecryptPass("MTIzNDEyMzQ="));
	...
	public void VerfiyActivity_Icon_AsUser() throws InterruptedException
	{
	...
	public void VerifyParametersComparision_InShareActivity_AsUser() throws Exception
	{
...
// Compare the values 
	...
	public void VerifyParametersComparision_MinValues_InShareActivity_AsUser() throws Exception
	{
...
// Compare the values 
	...
	public void VerifyParametersComparision_MaxValues_InShareActivity_AsUser() throws Exception
	{
...
// Compare the values 
	...
	public void VerifyStartTimeOfGraph_InShareActivity_AsUser() throws Exception
	{	
	...
	protected void OpenShareLinkURL() throws InterruptedException 
	{
		...
		Thread.sleep(1000);
		homeObj.shareActivityLink();
		Thread.sleep(1000);
		driver.get(homeObj.getShareActivityLink());
	}
