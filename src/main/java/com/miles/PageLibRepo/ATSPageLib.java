...
//	driver.findElement(By.xpath("//*[contains(@class, 'btn btn-primary')]")).click();
	...
	//--------------------------------------------------------------------------------------------------------//
		driver.findElement(By.xpath("//*[contains(@class, 'btn button_orange_color btn-secondary')]")).click();
Thread.sleep(2000);
		WebElement SubmissionScreenshot = driver.findElements(By.xpath("//button[normalize-space()='Submission Screenshot']")).get(0);
	...
	//	SubmissionScreenshot.click();
	  ...
	  //  WebElement fileInput = driver.findElement(By.xpath("//input[@type='file']"));
	    WebElement fileInput = driver.findElements(By.xpath("//button[normalize-space()='Submission Screenshot']")).get(0);
...
//		((JavascriptExecutor) driver).executeScript("arguments[0].click();", EmailScreenshot);
//		EmailScreenshot.click();
//	    Thread.sleep(5000);
//	    Robot robot2 = new Robot();
//	    StringSelection filePath2 = new StringSelection("C:\\Users\\Miles\\Pictures\\MASATTACHEMENT.png");
...
//	    StringSelection filePath3 = new StringSelection("C:\\Users\\Miles\\Pictures\\MASATTACHEMENT.png");
