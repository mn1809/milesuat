...
set "$taskName=RegressionTask"
set "$taskDescription=Regression Tests updating"
...
:: Cycle info
set $cycleName="E2EAutomationResult"
set $createNewCycle="false"
set $appendDateTimeInCycleName="false"

:: Folder info
set $folderName="FxWebAppRegression"
...
set $resultPath=@\"C:/ProgramData/Jenkins/.jenkins/workspace/E2E WebApplication Regression/frontierX/target/surefire-reports/TEST-TestSuite.xml\"
::Mandatory Field required from JIRA C:/ProgramData/Jenkins/.jenkins/workspace/E2E WebApplication Regression/frontierX/target/surefire-reports
